...
DBlockPartition::PartitionType DBlockPartition::partitionType() const
{
...
{
    static const QMap<QString, GUIDType> kGuidMap = {
        { "00000000-0000-0000-0000-000000000000", GUIDType::UnusedEntryNA },
        { "024DEE41-33E7-11D3-9D69-0008C781F39F", GUIDType::MBRPartitionSchemeNA },
        { "C12A7328-F81F-11D2-BA4B-00A0C93EC93B", GUIDType::EFISystemPartitionNA },
        { "21686148-6449-6E6F-744E-656564454649", GUIDType::BIOSBootPartitionNA },
        { "D3BFE2DE-3DAF-11DF-BA40-E3A556D89593", GUIDType::IntelFastFlashPartitionNA },
        { "F4019732-066E-4E12-8273-346C5641494F", GUIDType::SonyBootPartitionNA },
        { "BFBFAFE7-A34F-448A-9A5B-6213EB736C22", GUIDType::LenovoBootPartitionNA },
        { "E3C9E316-0B5C-4DB8-817D-F92DF00215AE", GUIDType::MicrosoftReservedPartitionWin },
        { "EBD0A0A2-B9E5-4433-87C0-68B6B72699C7", GUIDType::BasicDataPartitionWin },
        { "5808C8AA-7E8F-42E0-85D2-E1E90434CFB3", GUIDType::LogicalDiskManagerMetaDataPartitionWin },
        { "AF9B60A0-1431-4F62-BC68-3311714A69AD", GUIDType::LogicalDiskManagerDataPartitionWin },
        { "DE94BBA4-06D1-4D40-A16A-BFD50179D6AC", GUIDType::WindowsRecoveryEnvironmentWin },
        { "37AFFC90-EF7D-4E96-91C3-2D7AE055B174", GUIDType::IBMGeneralParallelFileSystemPartitionWin },
        { "E75CAF8F-F680-4CEE-AFA3-B001E56EFC2D", GUIDType::StorageSpacesPartitionWin },
        { "558D43C5-A1AC-43C0-AAC8-D1472B2923D1", GUIDType::StorageReplicaPartitionWin },
        { "75894C1E-3AEB-11D3-B7C1-7B03A0000000", GUIDType::DataPartitionHPUX },
        { "E2A1E728-32E3-11D6-A682-7B03A0000000", GUIDType::ServicePartitionHPUX },
        { "0FC63DAF-8483-4772-8E79-3D69D8477DE4", GUIDType::LinuxFilesystemDataLinux },
        { "A19D880F-05FC-4D3B-A006-743F0F84911E", GUIDType::RAIDPartitionLinux },
        { "44479540-F297-41B2-9AF7-D131D5F0458A", GUIDType::RootPartitionX86Linux },
        { "4F68BCE3-E8CD-4DB1-96E7-FBCAF984B709", GUIDType::RootPartitionX8664Linux },
        { "69DAD710-2CE4-4E3C-B16C-21A1D49ABED3", GUIDType::RootPartitionArm32Linux },
        { "B921B045-1DF0-41C3-AF44-4C6F280D3FAE", GUIDType::RootPartitionArm64Linux },
        { "BC13C2FF-59E6-4262-A352-B275FD6F7172", GUIDType::BootPartitionLinux },
        { "0657FD6D-A4AB-43C4-84E5-0933C84B4F4F", GUIDType::SwapPartitionLinux },
        { "E6D6D379-F507-44C2-A23C-238F2A3DF928", GUIDType::LogicalVolumeManagerPartitionLinux },
        { "933AC7E1-2EB4-4F13-B844-0E14E2AEF915", GUIDType::HomePartitionLinux },
        { "3B8F8425-20E0-4F3B-907F-1A25A76F98E8", GUIDType::ServerDataPartitionLinux },
        { "7FFEC5C9-2D00-49B7-8941-3EA10A5586B7", GUIDType::PlainDMCryptPartitionLinux },
        { "CA7D7CCB-63ED-4C53-861C-1742536059CC", GUIDType::LUKSPartitionLinux },
        { "8DA63339-0007-60C0-C436-083AC8230908", GUIDType::ReservedLinux },
        { "83BD6B9D-7F41-11DC-BE0B-001560B84F0F", GUIDType::BootPartitionFreeBSD },
        { "516E7CB4-6ECF-11D6-8FF8-00022D09712B", GUIDType::BSDDisklabelPartitionFreeBSD },
        { "516E7CB5-6ECF-11D6-8FF8-00022D09712B", GUIDType::SwapPartitionFreeBSD },
        { "516E7CB6-6ECF-11D6-8FF8-00022D09712B", GUIDType::UnixFileSystemPartitionFreeBSD },
        { "516E7CB8-6ECF-11D6-8FF8-00022D09712B", GUIDType::VinumVolumeManagerPartitionFreeBSD },
        { "516E7CBA-6ECF-11D6-8FF8-00022D09712B", GUIDType::ZFSPartitionFreeBSD },
        { "74BA7DD9-A689-11E1-BD04-00E081286ACF", GUIDType::NandfsPartitionFreeBSD },
        { "48465300-0000-11AA-AA11-00306543ECAC", GUIDType::HierarchialFileSystemPlusPartitionMacOS },
        { "7C3457EF-0000-11AA-AA11-00306543ECAC", GUIDType::AppleAPFSContainerMacOS },
        { "55465300-0000-11AA-AA11-00306543ECAC", GUIDType::AppleUFSContainerMacOS },
        { "6A898CC3-1DD2-11B2-99A6-080020736631", GUIDType::ZFSMacOS },
        { "52414944-0000-11AA-AA11-00306543ECAC", GUIDType::AppleRAIDPartitionMacOS },
        { "52414944-5F4F-11AA-AA11-00306543ECAC", GUIDType::AppleRAIDPartitionOfflineMacOS },
        { "426F6F74-0000-11AA-AA11-00306543ECAC", GUIDType::AppleBootPartitionMacOS },
        { "4C616265-6C00-11AA-AA11-00306543ECAC", GUIDType::AppleLabelMacOS },
        { "5265636F-7665-11AA-AA11-00306543ECAC", GUIDType::AppleTVRecoveryPartitionMacOS },
        { "53746F72-6167-11AA-AA11-00306543ECAC", GUIDType::AppleCoreStorageContainerMacOS },
        { "69646961-6700-11AA-AA11-00306543ECAC", GUIDType::AppleAPFSPrebootPartitionMacOS },
        { "52637672-7900-11AA-AA11-00306543ECAC", GUIDType::AppleAPFSRecoveryPartitionMacOS },
        { "6A82CB45-1DD2-11B2-99A6-080020736631", GUIDType::BootPartitionSolaris },
        { "6A85CF4D-1DD2-11B2-99A6-080020736631", GUIDType::RootPartitionSolaris },
        { "6A87C46F-1DD2-11B2-99A6-080020736631", GUIDType::SwapPartitionSolaris },
        { "6A8B642B-1DD2-11B2-99A6-080020736631", GUIDType::BackupPartitionSolaris },
        { "6A898CC3-1DD2-11B2-99A6-080020736631", GUIDType::UsrPartitionSolaris },
        { "6A8EF2E9-1DD2-11B2-99A6-080020736631", GUIDType::VarPartitionSolaris },
        { "6A90BA39-1DD2-11B2-99A6-080020736631", GUIDType::HomePartitionSolaris },
        { "6A9283A5-1DD2-11B2-99A6-080020736631", GUIDType::AlternateSectorSolaris },
        { "6A945A3B-1DD2-11B2-99A6-080020736631", GUIDType::ReservedPartitionSolaris },
        { "6A9630D1-1DD2-11B2-99A6-080020736631", GUIDType::ReservedPartitionSolaris },
        { "6A980767-1DD2-11B2-99A6-080020736631", GUIDType::ReservedPartitionSolaris },
        { "6A96237F-1DD2-11B2-99A6-080020736631", GUIDType::ReservedPartitionSolaris },
        { "6A8D2AC7-1DD2-11B2-99A6-080020736631", GUIDType::ReservedPartitionSolaris },
        { "49F48D32-B10E-11DC-B99B-0019D1879648", GUIDType::SwapPartitionNetBSD },
        { "49F48D5A-B10E-11DC-B99B-0019D1879648", GUIDType::FFSPartitionNetBSD },
        { "49F48D82-B10E-11DC-B99B-0019D1879648", GUIDType::LFSPartitionNetBSD },
        { "49F48DAA-B10E-11DC-B99B-0019D1879648", GUIDType::RAIDPartitionNetBSD },
        { "2DB519C4-B10F-11DC-B99B-0019D1879648", GUIDType::ConcatenatedPartitionNetBSD },
        { "2DB519EC-B10F-11DC-B99B-0019D1879648", GUIDType::EncryptedPartitionNetBSD },
        { "FE3A2A5D-4F32-41A7-B725-ACCC3285A309", GUIDType::KernelChromeOS },
        { "3CB8E202-3B7E-47DD-8A3C-7FF2A13CFCEC", GUIDType::RootfsChromeOS },
        { "CAB6E88E-ABF3-4102-A07A-D4BB9BE3C1D3", GUIDType::FirmwareChromeOS },
        { "2E0A753D-9E48-43B0-8337-B15192CB1B5E", GUIDType::FutureUseChromeOS },
        { "09845860-705F-4BB5-B16C-8A8A099CAF52", GUIDType::MiniOSChromeOS },
        { "3F0F8318-F146-4E6B-8222-C28C8F02E0D5", GUIDType::HibernateChromeOS },
        { "5DFBF5F4-2848-4BAC-AA5E-0D9A20B745A6", GUIDType::UsrPartitionCoreOS },
        { "3884DD41-8582-4404-B9A8-E9B84F2DF50E", GUIDType::ResizableRootfsCoreOS },
        { "C95DC21A-DF0E-4340-8D7B-26CBFA9A03E0", GUIDType::OEMCustomizationsCoreOS },
        { "BE9067B9-EA49-4F15-B4F6-F36F8C9E1818", GUIDType::RootFilesystemOnRAIDCoreOS },
        { "42465331-3BA3-10F1-802A-4861696B7521", GUIDType::HaikuBFSHaiku },
        { "85D5E45E-237C-11E1-B4B3-E89A8F7FC3A7", GUIDType::BootPartitionMidnightBSD },
        { "85D5E45A-237C-11E1-B4B3-E89A8F7FC3A7", GUIDType::DataPartitionMidnightBSD },
        { "85D5E45B-237C-11E1-B4B3-E89A8F7FC3A7", GUIDType::SwapPartitionMidnightBSD },
        { "0394EF8B-237E-11E1-B4B3-E89A8F7FC3A7", GUIDType::UnixFileSystemPartitionMidnightBSD },
        { "85D5E45C-237C-11E1-B4B3-E89A8F7FC3A7", GUIDType::VinumVolumemanagerPartitionMidnightBSD },
        { "85D5E45D-237C-11E1-B4B3-E89A8F7FC3A7", GUIDType::ZFSPartitionMidnightBSD },
        { "45B0969E-9B03-4F30-B4C6-B4B80CEFF106", GUIDType::JournalCeph },
        { "45B0969E-9B03-4F30-B4C6-5EC00CEFF106", GUIDType::DmCryptJournalCeph },
        { "4FBD7E29-9D25-41B8-AFD0-062C0CEFF05D", GUIDType::OSDCeph },
        { "4FBD7E29-9D25-41B8-AFD0-5EC00CEFF05D", GUIDType::DmCryptOSDCeph },
        { "89C57F98-2FE5-4DC0-89C1-F3AD0CEFF2BE", GUIDType::DiskinCreationCeph },
        { "89C57F98-2FE5-4DC0-89C1-5EC00CEFF2BE", GUIDType::DmCryptDiskinCreationCeph },
        { "CAFECAFE-9B03-4F30-B4C6-B4B80CEFF106", GUIDType::BlockCeph },
        { "30CD0809-C2B2-499C-8879-2D6B78529876", GUIDType::BlockDBCeph },
        { "5CE17FCE-4087-4169-B7FF-056CC58473F9", GUIDType::BlockWriteAheadlogCeph },
        { "FB3AABF9-D25F-47CC-BF5E-721D1816496B", GUIDType::LockboxForDmCryptKeysCeph },
        { "4FBD7E29-8AE0-4982-BF9D-5A8D867AF560", GUIDType::MultipathOSDCeph },
        { "45B0969E-8AE0-4982-BF9D-5A8D867AF560", GUIDType::MultipathJournalCeph },
        { "CAFECAFE-8AE0-4982-BF9D-5A8D867AF560", GUIDType::MultipathBlockCeph },
        { "7F4A666A-16F3-47A2-8445-152EF4D03F6C", GUIDType::MultipathBlockCeph },
        { "EC6D6385-E346-45DC-BE91-DA2A7C8B3261", GUIDType::MultipathBlockDBCeph },
        { "01B41E1B-002A-453C-9F17-88793989FF8F", GUIDType::MultipathblockwriteAheadogCeph },
        { "CAFECAFE-9B03-4F30-B4C6-5EC00CEFF106", GUIDType::DmCryptBlockCeph },
        { "93B0052D-02D9-4D8A-A43B-33A3EE4DFBC3", GUIDType::DmCryptBlockDBCeph },
        { "306E8683-4FE2-4330-B7C0-00A917C16966", GUIDType::DmCryptBlockWriteAheadlogCeph },
        { "45B0969E-9B03-4F30-B4C6-35865CEFF106", GUIDType::DmCryptLUKSjournalCeph },
        { "CAFECAFE-9B03-4F30-B4C6-35865CEFF106", GUIDType::DmCryptLUKSBlockCeph },
        { "166418DA-C469-4022-ADF4-B30AFD37F176", GUIDType::DmCryptLUKSBlockDBCeph },
        { "86A32090-3647-40B9-BBBD-38D8C573AA86", GUIDType::DmCryptLUKSBlockwriteAheadlogCeph },
        { "4FBD7E29-9D25-41B8-AFD0-35865CEFF05D", GUIDType::DmCryptLUKSOSDCeph },
        { "824CC7A0-36A8-11E3-890A-952519AD3F61", GUIDType::DataPartitionOpenBSD },
        { "CEF5A9AD-73BC-4601-89F3-CDEEEEE321A1", GUIDType::PowerSafeFilesystemQNX },
        { "C91818F9-8025-47AF-89D2-F030D7000C2C", GUIDType::Plan9PartitionPlan9 },
        { "9D275380-40AD-11DB-BF97-000C2911D1B8", GUIDType::VmkCoreVMwareESX },
        { "AA31E02A-400F-11DB-9590-000C2911D1B8", GUIDType::VMFSFilesystemPartitionVMwareESX },
        { "9198EFFC-31C0-11DB-8F78-000C2911D1B8", GUIDType::VMWareReservedVMwareESX },
        { "2568845D-2332-4675-BC39-8FA5A4748D15", GUIDType::BootloaderAndroidIA },
        { "114EAFFE-1552-4022-B26E-9B053604CF84", GUIDType::Bootloader2AndroidIA },
        { "49A4D17F-93A3-45C1-A0DE-F50B2EBE2599", GUIDType::BootAndroidIA },
        { "4177C722-9E92-4AAB-8644-43502BFD5506", GUIDType::RecoveryAndroidIA },
        { "EF32A33B-A409-486C-9141-9FFB711F6266", GUIDType::MiscAndroidIA },
        { "20AC26BE-20B7-11E3-84C5-6CFDB94711E9", GUIDType::MetadataAndroidIA },
        { "38F428E6-D326-425D-9140-6E0EA133647C", GUIDType::SystemAndroidIA },
        { "A893EF21-E428-470A-9E55-0668FD91A2D9", GUIDType::CacheAndroidIA },
        { "DC76DDA9-5AC1-491C-AF42-A82591580C0D", GUIDType::DataAndroidIA },
        { "EBC597D0-2053-4B15-8B64-E0AAC75F4DB1", GUIDType::PersistentAndroidIA },
        { "C5A0AEEC-13EA-11E5-A1B1-001E67CA0C3C", GUIDType::VendorAndroidIA },
        { "BD59408B-4514-490D-BF12-9878D963F378", GUIDType::ConfigAndroidIA },
        { "8F68CC74-C5E5-48DA-BE91-A0C8C15E9C80", GUIDType::FactoryAndroidIA },
        { "9FDAA6EF-4B3F-40D2-BA8D-BFF16BFB887B", GUIDType::FactoryAltAndroidIA },
        { "767941D0-2085-11E3-AD3B-6CFDB94711E9", GUIDType::FastbootOrTertiaryAndroidIA },
        { "AC6D7924-EB71-4DF8-B48D-E267B27148FF", GUIDType::OEMAndroidIA },
        { "19A710A2-B3CA-11E4-B026-10604B889DCF", GUIDType::AndroidMetaAndroid6Arm },
        { "193D1EA4-B3CA-11E4-B075-10604B889DCF", GUIDType::AndroidEXTAndroid6Arm },
        { "7412F7D5-A156-4B13-81DC-867174929325", GUIDType::BootONIE },
        { "D4E6E2CD-4469-46F3-B5CB-1BFF57AFC149", GUIDType::ConfigONIE },
        { "9E1A2D38-C612-4316-AA26-8B49521E5A8B", GUIDType::PRePBootPowerPC },
        { "BC13C2FF-59E6-4262-A352-B275FD6F7172", GUIDType::SharedBootloaderConfigurationFreedesktop },
        { "734E5AFE-F61A-11E6-BC64-92361F002671", GUIDType::BasicDataPartitionAtariTOS },
        { "8C8F8EFF-AC95-4770-814A-21994F2DBC8F", GUIDType::EncryptedDataPartitionVeraCrypt },
        { "90B6FF38-B98F-4358-A21F-48F35B4A8AD3", GUIDType::ArcaOSType1OS2 },
        { "7C5222BD-8F5D-4087-9C00-BF9843C7B58C", GUIDType::SPDKBlockDeviceSPDK },
        { "4778ED65-BF42-45FA-9C5B-287A1DC4AAB1", GUIDType::BareBoxStateBareboxBootloader },
        { "3DE21764-95BD-54BD-A5C3-4ABE786F38A8", GUIDType::UBootEnvironmentUBootBootloader },
        { "B6FA30DA-92D2-4A9A-96F1-871EC6486200", GUIDType::StatusSoftRAID },
        { "2E313465-19B9-463F-8126-8A7993773801", GUIDType::ScratchSoftRAID },
        { "FA709C7E-65B1-4593-BFD5-E71D61DE9B02", GUIDType::VolumeSoftRAID },
        { "BBBA6DF5-F46F-4A89-8F59-8765B2727503", GUIDType::CacheSoftRAID },
        { "FE8A2634-5E2E-46BA-99E3-3A192091A350", GUIDType::BootloaderFuchsiaStandard },
        { "D9FD4535-106C-4CEC-8D37-DFC020CA87CB", GUIDType::DurablemutableencryptedsystemdataFuchsiaStandard },
        { "A409E16B-78AA-4ACC-995C-302352621A41", GUIDType::DurablemutablebootloaderdataFuchsiaStandard },
        { "F95D940E-CABA-4578-9B93-BB6C90F29D3E", GUIDType::FactoryProvisionedreadOnlysystemdataFuchsiaStandard },
        { "10B8DBAA-D2BF-42A9-98C6-A7C5DB3701E7", GUIDType::FactoryProvisionedreadOnlybootloaderdataFuchsiaStandard },
        { "49FD7CB8-DF15-4E73-B9D9-992070127F0F", GUIDType::FuchsiaVolumeManagerFuchsiaStandard },
        { "421A8BFC-85D9-4D85-ACDA-B64EEC0133E9", GUIDType::VerifiedbootmetadataFuchsiaStandard },
        { "9B37FFF6-2E58-466A-983A-F7926D0B04E0", GUIDType::ZirconbootimageFuchsiaStandard },
        { "C12A7328-F81F-11D2-BA4B-00A0C93EC93B", GUIDType::FuchsiaEspFuchsiaLegacy },
        { "606B000B-B7C7-4653-A7D5-B737332C899D", GUIDType::FuchsiaSystemFuchsiaLegacy },
        { "08185F0C-892D-428A-A789-DBEEC8F55E6A", GUIDType::FuchsiaDataFuchsiaLegacy },
        { "48435546-4953-2041-494E-5354414C4C52", GUIDType::FuchsiaInstallFuchsiaLegacy },
        { "2967380E-134C-4CBB-B6DA-17E7CE1CA45D", GUIDType::FuchsiaBlobFuchsiaLegacy },
        { "41D0E340-57E3-954E-8C1E-17ECAC44CFF5", GUIDType::FuchsiaFvmFuchsiaLegacy },
        { "DE30CC86-1F4A-4A31-93C4-66F147D33E05", GUIDType::ZirconbootimageSlotAFuchsiaLegacy },
        { "23CC04DF-C278-4CE7-8471-897D1A4BCDF7", GUIDType::ZirconbootimageSlotBFuchsiaLegacy },
        { "A0E5CF57-2DEF-46BE-A80C-A2067C37CD49", GUIDType::ZirconbootimageSlotRFuchsiaLegacy },
        { "4E5E989E-4C86-11E8-A15B-480FCF35F8E6", GUIDType::SysConfigFuchsiaLegacy },
        { "5A3A90BE-4C86-11E8-A15B-480FCF35F8E6", GUIDType::FactoryConfigFuchsiaLegacy },
        { "5ECE94FE-4C86-11E8-A15B-480FCF35F8E6", GUIDType::BootloaderFuchsiaLegacy },
        { "8B94D043-30BE-4871-9DFA-D69556E8C1F3", GUIDType::GuidTestFuchsiaLegacy },
        { "A13B4D9A-EC5F-11E8-97D8-6C3BE52705BF", GUIDType::VerifiedbootmetadataSlotAFuchsiaLegacy },
        { "A288ABF2-EC5F-11E8-97D8-6C3BE52705BF", GUIDType::VerifiedbootmetadataSlotBFuchsiaLegacy },
        { "6A2460C3-CD11-4E8B-80A8-12CCE268ED0A", GUIDType::VerifiedbootmetadataSlotRFuchsiaLegacy },
        { "1D75395D-F2C6-476B-A8B7-45CC1C97B476", GUIDType::MiscFuchsiaLegacy },
        { "900B0FC5-90CD-4D4F-84F9-9F8ED579DB88", GUIDType::EmmcBoot1FuchsiaLegacy },
        { "B2B2E8D1-7C10-4EBC-A2D0-4614568260AD", GUIDType::EmmcBoot2FuchsiaLegacy },
    };
...
QString DBlockPartition::typeDescription(DBlockPartition::PartitionType type)
{
    switch (type) {
    case Empty:
        return "Empty";
...
QString DBlockPartition::guidTypeDescription(DBlockPartition::GUIDType type)
{
    switch (type) {
    case UnusedEntryNA:
        return "Unused entry";
    ...
    : DBlockDevice(*new DBlockPartitionPrivate(this), path, parent)
{
    ...
    connect(this, &DBlockPartition::typeChanged, this, &DBlockPartition::partitionTypeChanged);
